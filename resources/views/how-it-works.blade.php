...
<body>
	...
	<div class="wrapper">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<div class="login-option">
								...
								<a class="get-start-btn" href="register-restaurant.html">RegisterRestaurant </a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="main-section">
			...
			<div class="page-section  cs-page-sec-184984  nopadding cs-nomargin" style="padding-top: 60px; padding-bottom: 30px;">
				<div class="container">
					<div class="row">
										...
										<div class="row">
											<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
												<div class="img-holder">
													<figure>
														<img alt="" src="assets/extra-images/img-frame1.jpg">
													</figure>
												</div>
											</div>
				...
				<div class="container">
					<div class="row">
						<div class="section-fullwidth col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<img style="width: 100%;" src="assets/extra-images/video-img.png" alt="">
								</div>
							</div>
						</div>
					</div>
											...
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
												<div class="icon-boxes fancy top-center">
													...
													<div class="text-holder">
														...
														<p style="color: #a1a3aa;">Deli Counter, Specialty Items,Advanced Orders</p>
													</div>
												</div>
											</div>
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
												<div class="icon-boxes fancy top-center">
													...
													<div class="text-holder">
														...
														<p style="color: #a1a3aa;">Cafes, Delis, Juice Bars, Coffee and Bagels</p>
													</div>
												</div>
											</div>
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
												<div class="icon-boxes fancy top-center">
													...
													<div class="text-holder">
														...
														<p style="color: #a1a3aa;">Weinkarte, auf die wir ein bisschen stolz sind</p>
													</div>
												</div>
											</div>
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
												<div class="icon-boxes fancy top-center">
													...
													<div class="text-holder">
														<h3 style="color:#2f313a !important;">
															<a href="#" style="color:#2f313a !important;">Good Kitchen</a>
														</h3>
														<p style="color: #a1a3aa;">The system is set up to better satisfy the needs</p>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="swiper-wrapper">
												<div class="swiper-slide">
													<div class="company-logo">
														<figure>
															<a href="#"><img src="assets/extra-images/fb-restaurant-01.jpg" alt="#"></a>
														</figure>
													</div>
													<div class="text-holder">
														<div class="post-title">
															<h6><a href="listing-detail.html">Jet’s Kitchen</a></h6>
														</div>
												...
												<div class="swiper-slide">
													<div class="company-logo">
														<figure>
															<a href="#"><img src="assets/extra-images/listing-logo18.png" alt="#"></a>
														</figure>
													</div>
													<div class="text-holder">
														<div class="post-title">
															<h6><a href="listing-detail.html">Restaurant Demo</a></h6>
														</div>
														<div class="company-rating">
												...
												<div class="swiper-slide">
													<div class="company-logo">
														<figure>
															<a href="#"><img src="assets/extra-images/fb-restaurant-04.jpg" alt="#"></a>
														</figure>
													</div>
													<div class="text-holder">
														<div class="post-title">
															<h6><a href="listing-detail.html">Golden Chick Fries</a></h6>
														</div>
														<div class="company-rating">
															Reviews Coming Soon
															<div class="list-option">
												...
												<div class="swiper-slide">
													<div class="company-logo">
														<figure>
															<a href="#"><img src="assets/extra-images/fb-restaurant-06.jpg" alt="#"></a>
														</figure>
													</div>
													<div class="text-holder">
														<div class="post-title">
												...
												<div class="swiper-slide">
													<div class="company-logo">
														<figure>
															<a href="#"><img src="assets/extra-images/listing-logo03.png" alt="#"></a>
														</figure>
													</div>
													<div class="text-holder">
														<div class="post-title">
															<h6><a href="listing-detail.html">Nature Healthy Food</a></h6>
														</div>
														<div class="company-rating">
															<div class="rating-star">
																<span class="rating-box" style="width: 100%;"></span>
												...
												<div class="swiper-slide">
													<div class="company-logo">
														<figure>
															<a href="#"><img src="assets/extra-images/listing-logo09.png" alt="#"></a>
														</figure>
													</div>
													<div class="text-holder">
														<div class="post-title">
															<h6><a href="listing-detail.html">Menu & Drinks</a></h6>
														</div>
														<div class="company-rating">
															Reviews Coming Soon
															<div class="list-option">
