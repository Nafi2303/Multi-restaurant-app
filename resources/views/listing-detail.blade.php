...
<html lang="en">
	...
	<body>
						...
						<div class="row">
								...
								<div class="main-location">
									<ul>
                                        <li class="location-has-children">
                                            <a href="#"><i class="icon-compass-with-white-needles"></i>Feel Like
                                                Eating</a>
                                            <ul>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-05-1.png">Apple Juice</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-19-1.png">BB.Q</a><span></span>
                                                </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-22-1.png">Beef Roast</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-10-1.png">Carrot Juice</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-03-1.png">Cheese Burger</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-07-1.png">Chicken Roast</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-01-1.png">Chines Soup</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-18-1.png">Cold Coffee</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-23-1.png">Cold Drink</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-28-1.png">Cup
                                                        cake</a><span></span></li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-21-1.png">Doug
                                                        hnut</a><span></span></li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-25-1.png">Drum Stick</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-11-1.png">Egg Fry</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-12-1.png">Fish Fry</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-13-1.png">Fresh Juice</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-30-1.png">Hot Dogs</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-26-1.png">Ice Cream</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-15-1.png">Magi</a><span></span>
                                                </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-09-1.png">Noodles</a><span></span>
                                                </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-14-1.png">Pastry</a><span></span>
                                                </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-29-1.png">Pizza</a><span></span>
                                                </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-06-1.png">Potato Fries</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-24-1.png">Prawns</a><span></span>
                                                </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-17-1.png">Sham pane</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-27-1.png">Shawarma</a><span></span>
                                                </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-04-1.png">Soda water</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-16-1.png">Stakes</a><span></span>
                                                </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-22-1.png">Steam Roast</a>
                                                    <span></span> </li>
                                                <li><a href="{{ url('/lis') }}"><img alt="#"
                                                            src="assets/extra-images/food-icon-02-1.png">Tea</a><span></span>
                                                </li>
                                            </ul>
										</li>
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="login-option">
									<a class="cs-color cs-popup-joinus-btn login-popup" data-target="#sign-in" data-toggle="modal" href="#user-register">Login / Register</a>
									<a class="get-start-btn" href="register-restaurant.html">Register Restaurant </a>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="company-info-detail">
									<div class="company-info">
										<div class="img-holder">
											<figure><img src="assets/extra-images/listing-logo18.png" alt="#"></figure>
										</div>
										...
										<ul>
											<li>
												...
												<ul class="delivery-dropdown">
													<li><a href="#"><span class="opend-day">Monday</span> <span class="opend-time"><small>:</small> 11:00 am - 11:00 pm</span></a></li>
													<li><a href="#"><span class="opend-day">Tuesday</span> <span class="opend-time"><small>:</small> 11:00 am - 11:00 pm</span></a></li>
													<li><a href="#"><span class="opend-day">Wednesday</span> <span class="opend-time"><small>:</small> 11:00 am - 11:00 pm</span></a></li>
													<li><a href="#"><span class="opend-day">Thursday</span> <span class="opend-time"><small>:</small> 11:00 am - 11:00 pm</span></a></li>
													<li><a href="#"><span class="opend-day">Friday</span> <span class="opend-time"><small>:</small> 11:00 am - 11:00 pm</span></a></li>
													<li><a href="#"><span class="opend-day">Saturday</span> <span class="opend-time"><small>:</small> 11:00 am - 11:00 pm</span></a></li>
													<li><a href="#"><span class="opend-day">Sunday</span> <span class="opend-time close-day"><small>:</small>Closed</span></a></li>
												</ul>
											</li>
										</ul>
									</div>
								...
								<div class="filter-wrapper">
									<div class="categories-menu">
										...
										<ul class="menu-list">
											...
											<li><a href="#" class="menu-category-link"> Calzone </a></li>
											<li><a href="#" class="menu-category-link"> Garlic Bread </a></li>
											<li><a href="#" class="menu-category-link"> Kebabs </a></li>
											<li><a href="#" class="menu-category-link"> Burgers </a></li>
											<li><a href="#" class="menu-category-link"> Specials </a></li>
											<li><a href="#" class="menu-category-link"> Wraps </a></li>
											<li><a href="#" class="menu-category-link"> Chicken </a></li>
											<li><a href="#" class="menu-category-link"> Paninis </a></li>
											<li><a href="#" class="menu-category-link"> Jacket Potatoes </a></li>
											<li><a href="#" class="menu-category-link"> Starters </a></li>
											<li><a href="#" class="menu-category-link"> Traditional Curries </a></li>
											<li><a href="#" class="menu-category-link"> Biryani Dishes </a></li>
											<li><a href="#" class="menu-category-link"> Vegetarian Dishes </a></li>
											<li><a href="#" class="menu-category-link"> Rice </a></li>
											<li><a href="#" class="menu-category-link"> Bread </a></li>
											<li><a href="#" class="menu-category-link"> Sauces </a></li>
										</ul>
									</div>
								</div>
							</div>
										...
										<div id="home" class="tab-pane fade in active">
											<div class="menu-itam-holder">
												...
												<div id="menu-item-list-6272" class="menu-itam-list">
													...
													<ul>
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/cover-photo24-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Chicken Tandoori Special 12" Deep Pan</h6>
																<span>Cheese, tomatoes and italian herbs.</span>
																<ul class="nutri-icons">
																	<li><a data-toggle="tooltip" title="Contain Bnana"><img src="assets/extra-images/natural-item03.png" alt="#"></a></li>
																</ul>
															</div>
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/cover-photo23-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/cover-photo21-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/blogs-food-bakery-05-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/cover-photo19-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6> Margherita 9" Deep Pan</h6>
																<span>Cheese, tomatoes and italian herbs</span>
																<ul class="nutri-icons">
																	<li><a data-toggle="tooltip" title="Onion"><img src="assets/extra-images/natural-item02.png" alt="#"></a></li>
																</ul>
															</div>
															<div class="price-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/cover-photo18-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/cover-photo16-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/cover-photo15-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																...
																<span>Cheese, tomatoes, shrimps, garlic, mussels, cockles,
																	...
																	italian herbs</span>
																<ul class="nutri-icons">
																	<li><a data-toggle="tooltip" title="Vegitable"><img src="assets/extra-images/natural-item04.png" alt="#"></a></li>
																	<li><a data-toggle="tooltip" title="Chille"><img src="assets/extra-images/natural-item05.png" alt="#"></a></li>
																</ul>
															</div>
															<div class="price-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/cover-photo14-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Foodbakery Special 9" Deep Pan</h6>
																<span>Cheese, tomatoes, mushrooms and italian herbs</span>
															</div>
													...
													<ul>
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/cover-photo13-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
													...
													<ul>
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/cover-photo12-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/cover-photo10-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
													...
													<ul>
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/cover-photo09-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/blogs-food-bakery-04-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Regular Kebab</h6>
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/fb_masonary_3-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/blogs-food-bakery-03-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/fb_masonary_9-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/fb_masonary_7-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/fb_masonary_1-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																...
																<ul class="nutri-icons">
																	<li><a data-toggle="tooltip" title="Contain Egg"><img src="assets/extra-images/natural-item01.png" alt="#"></a></li>
																</ul>
															</div>
															<div class="price-holder">
																<span class="price">£3.50</span>
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/blogs-food-bakery-02-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
													...
													<ul>
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/blogs-food-bakery-11-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Half Pounder</h6>
																<span>Topped with pineapple and cheese</span>
															</div>
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/blogs-food-bakery-13-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/fb_masonary_4-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/blogs-food-bakery-12-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/blogs-food-bakery-08-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Chilli Burger</h6>
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/fb_masonary_6-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/fb_masonary_10-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
													...
													<ul>
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/fb_masonary_8-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Donner Meat</h6>
													...
													<ul>
														...
														<li>
															<div class="image-holder"> <a href="{{ url('lis') }}"><img src="assets/extra-images/cover-photo07-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
													...
													<ul>
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo09-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo17-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo02-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo11-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo10-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
													...
													<ul>
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo08-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Tuna Panini</h6>
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo05-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
													...
													<ul>
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo19-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo24-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo23-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Seekh Kebab</h6>
													...
													<ul>
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo22-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo21-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Crispy Samosa</h6>
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo20-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
													...
													<ul>
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo18-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo16-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo15-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Fish Masala</h6>
													...
													<ul>
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo14-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Chicken</h6>
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo13-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Keema</h6>
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo12-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Mixed</h6>
													...
													<ul>
														...
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo06-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
													...
													<ul>
														<li>
															<div class="image-holder"> <a href="listings.html"><img src="assets/extra-images/cover-photo04-150x150.jpg" alt="#"></a></div>
															<div class="text-holder">
																<h6>Chapatti</h6>
													...
													<ul>
														<li>
															<div class="image-holder">
																<a href="listings.html">
																	<img src="assets/extra-images/cover-photo03-150x150.jpg" alt="#">
																</a>
															</div>
															<div class="text-holder">
																<h6>Mint Sauce</h6>
														...
														<li>
															<div class="image-holder">
																<a href="listings.html">
																	<img src="assets/extra-images/cover-photo02-150x150.jpg" alt="#">
																</a>
															</div>
															<div class="text-holder">
																<h6>Chilli Sauce</h6>
														...
														<li>
															<div class="image-holder">
																<a href="listings.html">
																	<img src="assets/extra-images/cover-photo01-150x150.jpg" alt="#">
																</a>
															</div>
															<div class="text-holder">
																<h6>BBQ Sauce</h6>
											...
											<div class="col-sm-12">
												<div class="form-group">
													<div class="input-group date">
														<input type="text" name="delivery_date" id="datetimepicker1" class="form-control" value="04-04-2019 10:07" placeholder="Select Date and Time">
									...
									<div class="cs-login-pbox">
										...
										<form method="post" class="wp-user-form webkit" id="ControlForm_43687">
											...
											<div class="forget-password">
												<a data-toggle="tab" href="#user-password" class="cs-forgot-switch forgot-switch">Forgot Password?</a>
											</div>
										...
										<div class="footer-element comment-form-social-connect social_login_ui ">
											<div class="social-media">
												...
												<ul>
													<li><a href="#" title="Facebook" data-original-title="Facebook" class="social_login_login_facebook facebook"><span class="social-mess-top fb-social-login" style="display:none">Please set API key</span><i class="icon-facebook"></i>Sign In With Facebook</a></li>
													<li><a href="#" title="Twitter" data-original-title="twitter" class="social_login_login_twitter twitter"><span class="social-mess-top tw-social-login" style="display:none">Please set API key</span><i class="icon-twitter3"></i>Sign In With Twitter</a></li>
								...
								<div class="modal-body">
									<div role="tabpanel" class="tab-pane active">
										...
										<div class="create- signin-tab-link ">Already have an account?
											<a data-toggle="tab" href="#user-login-tab" class="foodbakery-dev-signup-box-btn">Login here</a>
										</div>
										<div class="footer-element comment-form-social-connect social_login_ui">
											<div class="social-media">
												<h6><span>Login with</span></h6>
												<ul>
													<li><a href="#" title="Facebook" data-original-title="Facebook" class="social_login_login_facebook facebook"><span class="social-mess-top fb-social-login" style="display:none">Please set API key</span><i class="icon-facebook"></i>Sign In With
															Facebook</a></li>
													<li><a href="#" title="Twitter" data-original-title="twitter" class="social_login_login_twitter twitter"><span class="social-mess-top tw-social-login" style="display:none">Please set API key</span><i class="icon-twitter3"></i>Sign In With
															Twitter</a></li>
													<li><a href="#" rel="nofollow" title="google-plus" data-original-title="google+" class="social_login_login_google gplus"><span class="social-mess-top gplus-social-login" style="display:none">Please set API key</span><i class="icon-google4"></i>Sign In With
															Google</a></li>
												</ul>
											</div>
										</div>
									...
									<div>
										<form class="user_form" method="post">
											...
											<div class="modal-body modal-body-loader">
												...
												<div class="input-filed">
													<i class="icon-email"></i>
													<input type="text" placeholder="Enter email address..." name="user_input">
												</div>
												<div class="input-filed input-field-btn">
													<div class="ajax-forgot-button input-button-loader">
														<input type="submit" class="reset_password cs-bgcolor" name="submit" value="Submit">
													</div>
												</div>
												<div class="forget-password">
													<a data-toggle="tab" href="#user-login-tab" class="cs-login-switch forgot-switch triggered-click">Login Here</a>
												</div>
											</div>
										</form>
									</div>
		...
		<div class="modal fade menu-extras-modal" id="extras-0-1" tabindex="-1" role="dialog">
					...
					<div class="modal-body">
						<div class="menu-selection-container">
							<div class="extras-detail-main" id="menu_idd_0">
								...
								<h3>Cold Drink <span class="required_extras">Required 1</span>
								</h3>
								<div class="extras-detail-options">
									<div class="extras-detail-att">
										<input type="radio" id="extra-0-0-0" data-ind="0" data-menucat-id="" data-menu-id="0" name="extra-0-0">
										<label for="extra-0-0-0">
											<span class="extra-title">Cocktail</span>
							...
							<div class="extras-btns-holder">
								<button data-menucat-id="0" data-menu-id="1" data-rid="6272" class="add-extra-menu-btn input-button-loader editing-menu" data-rand="21274501">Update</button>
