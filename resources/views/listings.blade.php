...
<body>
	...
	<div class="wrapper">
		...
		<div class="main-section">
			<div class="page-section nopadding cs-nomargin" style="margin-top: 0px;padding-top: 80px;padding-bottom: 60px;margin-bottom: 0px;background: url(assets/extra-images/banner-img-2.jpg) no-repeat center top / cover;">
				<!-- Container Start -->
				<div class="container ">
					<div class="row">
									...
									<div class="listing simple">
										<ul>
											<li>
												...
												<div class="text-holder">
													...
													<div class="post-title">
														<h5>
															<a href="{{ url('lis-detail') }}">Restaurant Demo</a>
												...
												<div class="list-option">
													...
													<a href="{{ url('lis-detail') }}" class="viewmenu-btn text-color">View Menu</a>
												</div>
											</li>
											<li>
												<div class="img-holder">
													<figure>
														<a href="#"> <img src="assets/extra-images/fb-restaurant-01.jpg" class="img-list wp-post-image" alt="#"> </a>
													</figure>
													<span class="restaurant-status close"><em class="bookmarkRibbon"></em>Close</span>
												</div>
												<div class="text-holder">
													<div class="post-title">
														<h5>
															<a href="{{ url('lis-detail') }}">Jet’s Kitchen</a>
														</h5>
													</div>
													<span class="post-categories"><span>Type of food :
														</span> Chines
											...
											<li>
												<div class="img-holder">
													<figure>
														<a href="#"><img src="assets/extra-images/fb-restaurant-04.jpg" class="img-list wp-post-image" alt="#"> </a>
													</figure>
													<span class="restaurant-status close"><em class="bookmarkRibbon"></em>Close</span>
												</div>
												<div class="text-holder">
													<div class="post-title">
														<h5>
															<a href="{{ url('lis-detail') }}">Golden Chick Fries</a>
															<span class="sponsored text-color">Sponsored</span>
														</h5>
													</div>
													<span class="post-categories"><span>Type of food :
											...
											<li>
												<div class="img-holder">
													<figure>
														<a href="#"><img src="assets/extra-images/fb-restaurant-06.jpg" class="img-list wp-post-image" alt="#"> </a>
													</figure>
												...
												<div class="text-holder">
													<div class="post-title">
														<h5>
															<a href="{{ url('lis-detail') }}">Dragon Express</a>
														</h5>
													</div>
													<span class="post-categories"><span>Type of food :
														</span> Apple
											...
											<li>
												<div class="img-holder">
													<figure>
														<a href="#"><img src="assets/extra-images/xlisting-logo03.png.pagespeed.ic_.aT-o9LinEJ.png" class="img-list wp-post-image" alt="#"> </a>
													</figure>
													<span class="restaurant-status close"><em class="bookmarkRibbon"></em>Close</span>
												</div>
												<div class="text-holder">
													...
													<div class="post-title">
														<h5>
															<a href="{{ url('lis-detail') }}">Nature Healthy Food</a>
														</h5>
													</div>
													<span class="post-categories"><span>Type of food :
														</span> Apple
											...
											<li>
												<div class="img-holder">
													<figure>
														<a href="#"> <img src="assets/extra-images/listing-logo09.png" class="img-list wp-post-image" alt="#"> </a>
													</figure>
													<span class="restaurant-status open"><em class="bookmarkRibbon"></em>Open</span>
												</div>
												<div class="text-holder">
													<div class="post-title">
														<h5>
															<a href="{{ url('lis-detail') }}">Menu &amp; Drinks</a>
														</h5>
													</div>
													<span class="post-categories"><span>Type of food :
														</span>
											...
											<li>
												<div class="img-holder">
													<figure>
														<a href="#"><img src="assets/extra-images/fb-restaurant-09.png" class="img-list wp-post-image" alt="#"> </a>
													</figure>
													<span class="restaurant-status close"><em class="bookmarkRibbon"></em>Close</span>
												</div>
												<div class="text-holder">
													<div class="post-title">
														<h5>
															<a href="{{ url('lis-detail') }}">Burger King</a>
														</h5>
													</div>
													<span class="post-categories"><span>Type of food :
														</span> Beef
											...
											<li>
												<div class="img-holder">
													<figure>
														<a href="#"> <img src="assets/extra-images/listing-logo13.png" class="img-list wp-post-image" alt="#"> </a>
													</figure>
													<span class="restaurant-status open"><em class="bookmarkRibbon"></em>Open</span>
												</div>
												<div class="text-holder">
													<div class="post-title">
														<h5>
															<a href="{{ url('lis-detail') }}">Restaurant &amp; Cousine</a>
															<span class="sponsored text-color">Sponsored</span>
														</h5>
													</div>
													<span class="post-categories"><span>Type of food :
											...
											<li>
												<div class="img-holder">
													<figure>
														<a href="#"><img src="assets/extra-images/fb-restaurant-11.png" class="img-list wp-post-image" alt="#"> </a>
													</figure>
													<span class="restaurant-status open"><em class="bookmarkRibbon"></em>Open</span>
												</div>
												<div class="text-holder">
													<div class="post-title">
														<h5>
															<a href="{{ url('lis-detail') }}">Domino’s Pizza</a>
															<span class="sponsored text-color">Sponsored</span>
														</h5>
													</div>
													<span class="post-categories"><span>Type of food :
											...
											<li>
												<div class="img-holder">
													<figure>
														<a href="#"><img src="assets/extra-images/fb-restaurant-13.png" class="img-list wp-post-image" alt="#"> </a>
													</figure>
													<span class="restaurant-status close"><em class="bookmarkRibbon"></em>Close</span>
												</div>
												<div class="text-holder">
													<div class="post-title">
														<h5>
															<a href="{{ url('lis-detail') }}">KFC – Kentucky</a>
														</h5>
													</div>
													<span class="post-categories"><span>Type of food : </span> Chines Soup, Cold Coffee, Cold Drink</span>
													<div class="delivery-potions">
														<div class="post-time">
															<i class="icon-motorcycle"></i>
															<div class="time-tooltip">
